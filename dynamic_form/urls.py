...
urlpatterns = [
    ...
    # path('password-rest/',auth_views.PasswordRestView.as_view(template_name='users/password_reset.html'), name='web-password-reset'),
    # path('password-rest/successfull',auth_views.PasswordRestDoneView.as_view(template_name='users/password_reset_done.html'), name='web-password-reset-done'),
